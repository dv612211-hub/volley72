      ...
      <header className="sticky top-0 z-20 border-b border-white/5 bg-[#0b1535]/80 backdrop-blur">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-4 sm:px-8">
          ...
          <nav className="hidden items-center gap-7 text-sm text-slate-300 md:flex">
            ...
            {isAdmin && (
              <a href="/admin" className="relative hover:text-white">
                Заявки
                {pendingCount > 0 && (
                  <span className="absolute -right-4 -top-2 grid h-4 min-w-4 place-items-center rounded-full bg-orange-500 px-1 text-[10px] font-bold text-[#0b1535]">
                    {pendingCount}
                  </span>
                )}
              </a>
          ...
          {isAdmin && (
            <a href="/admin" className="relative mr-2 flex items-center rounded-full bg-white/10 px-3 py-2 text-sm font-semibold text-white transition hover:bg-white/20">
              Заявки
              {pendingCount > 0 && (
                <span className="ml-1.5 grid h-5 min-w-5 place-items-center rounded-full bg-orange-500 px-1 text-[11px] font-bold text-[#0b1535]">
                  {pendingCount}
                </span>
              )}
            </a>
